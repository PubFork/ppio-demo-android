package io.pp.net_disk_demo.nebulas.account;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;

import io.pp.net_disk_demo.nebulas.core.Address;
//import io.pp.net_disk_demo.nebulas.core.Transaction;
...
import io.pp.net_disk_demo.nebulas.crypto.keystore.*;
...
public class AccountManager {
    ...
    public Address newAccount(byte[] passphrase, String privKey) throws Exception {
        byte[] bytePrivKey = parseHexBinary(privKey);
